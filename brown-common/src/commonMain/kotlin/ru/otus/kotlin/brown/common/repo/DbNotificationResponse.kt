...
data class DbNotificationResponse(
    ...
    companion object {
        ...
        fun error(error: NotificationError, data: Notification? = null) = DbNotificationResponse(null, false, listOf(error))
        fun error(errors: List<NotificationError>, data: Notification? = null) = DbNotificationResponse(null, false, errors)
