...
import ru.otus.kotlin.brown.api.v1.models.NotificationSearchFilter
...
data class NotificationSearchRequest (
    ...
    @field:JsonProperty("notificationFilter")
    val notificationFilter: NotificationSearchFilter? = null
